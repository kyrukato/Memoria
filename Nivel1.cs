...
namespace Memoria
{
    ...
    public partial class Nivel1 : Form
    {
        ...
        public Nivel1()
        {
            ...
            //Inicializamos la variable de control de tiempo
            ...
            if(btnEncenderApagar.BackgroundImage == Properties.Resources.microphone_slash_solid)
            {
                tt.SetToolTip(btnEncenderApagar, "MICROFONO APAGADO");
            }
            else
            {
                tt.SetToolTip(btnEncenderApagar, "MICROFONO ENCENDIDO");
            }
        }
        ...
        //Al cargar el juego se aplicaran estas configuraciones
        private void Nivel1_Load(object sender, EventArgs e)
        {
            ...
            Ajustar();
            Configuracion();
            int puntos = abc.ConsultarPuntaje(nombre, 1);
            lblPuntajemax.Text = "PUNTAJE MAXIMO: " + puntos.ToString("D4");
            paneladivinar.Visible = false;
        }

        //Seleccionamos la paleta de colores y personalizamos la ventana a mostrar
        ...
        private void Ajustar()
        {
            ...
            btnEncenderApagar.BackgroundImageLayout = ImageLayout.Zoom;
        ...
        //Función que muestra el tiempo transcurrido al iniciar el nivel
        ...
        private void pbRegresar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("TU PUNTUACIÓN NO SE GUARDARÁ");
        ...
        {
            DialogResult result = MessageBox.Show("¿SEGURO QUE DESEA REINICIAR EL NIVEL?", "ADVERTENCIA", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
